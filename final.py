...
welcome.say("Welcome to HSBC Interpreter")
welcome.runAndWait()
...
def text_mode(cam):
	...
	while True:
		...
		if len(contours) > 0:
			...
			if cv2.contourArea(contour) > 10000:
				...
				if count_same_frame > 10:
					...
					if word == "Account Balance":
						word = "Your Account Balance is 20000"
					if word == "Investment":
						word = "Your investment is 1 million"
					count_same_frame = 0
		...
		cv2.putText(whiteboard, "Predicted text- " + text, (30, 100), cv2.FONT_HERSHEY_TRIPLEX, 1, (0, 0, 0))
